...
Developer using Windows or Ubuntu and watching GitLab pipelines across many browser tabs.
...
Electron with plain HTML/CSS/JavaScript is an implementation choice for native Windows and Ubuntu (X11/XWayland) always-on-top windows.
